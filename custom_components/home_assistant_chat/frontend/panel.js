...
const STRINGS = {
  en: {
    ...
    messageDeleted:"Message deleted", serverMessage:"Server", showDeletedMessages:"Show a marker for deleted messages", userSettingsHint:"Manage the people you have blocked.",
  ...
  de: {
    ...
    messageDeleted:"Nachricht gelöscht", serverMessage:"Server", showDeletedMessages:"Markierung für gelöschte Nachrichten anzeigen", userSettingsHint:"Verwalte die von dir blockierten Benutzer.",
  ...
  async adminDialog() {
    ...
    const show = async (tab) => {
      if (tab === "channels") {
        ...
        content.querySelector(".save-settings").addEventListener("click", async () => { await this.ws({type:"home_assistant_chat/settings", enabled:content.querySelector("#setting-enabled").checked, allow_users:content.querySelector("#setting-users").checked, attachments_enabled:content.querySelector("#setting-attachments").checked, federation_qr_enabled:content.querySelector("#setting-federation-qr").checked, federation_address:content.querySelector("#setting-federation-address").value.trim(), federation_port:Number(content.querySelector("#setting-federation-port").value || 0), retention_days:Number(content.querySelector("#setting-retention").value), show_security_details:content.querySelector("#setting-security").checked, show_deleted_messages:content.querySelector("#setting-deleted-markers").checked}); await reload(); await show("settings"); });
